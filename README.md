...
Other fields are optional, If these fields could not be generated from the supplied BAM file, they be be filled in as appropriate or removed.
...
```
Your generated json file will be output as `<bam file basename>.json`, and any error messages will be written to `output.log`.